...
echo "MAX_CONCURRENT_PROOFS:  $MAX_CONCURRENT_PROOFS"
...
echo "POOL_STATE_FILE:        $POOL_STATE_FILE"
echo ""
echo "Endpoints:"
...
echo "  GET  http://${PROOF_POOL_BIND_ADDR}/proof_generation?auth_token=$AUTH_TOKEN&max_concurrent_proofs=3"
