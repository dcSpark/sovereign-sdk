...
export SOV_METRICS_API_MATERIALIZED_VIEW_READS_ENABLED="${SOV_METRICS_API_MATERIALIZED_VIEW_READS_ENABLED:-false}"
export SOV_METRICS_API_INCREMENTAL_ROLLUP_BACKFILL_ENABLED="${SOV_METRICS_API_INCREMENTAL_ROLLUP_BACKFILL_ENABLED:-false}"
...
echo "MV reads:        enabled=${SOV_METRICS_API_MATERIALIZED_VIEW_READS_ENABLED}"
echo "Rollup backfill: enabled=${SOV_METRICS_API_INCREMENTAL_ROLLUP_BACKFILL_ENABLED}"
