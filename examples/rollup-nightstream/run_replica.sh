...
cd "$WORKSPACE_ROOT"
SKIP_GUEST_BUILD=1 cargo build --release -p sov-rollup-nightstream --features sov-modules-rollup-blueprint/tee
...
"$WORKSPACE_ROOT/target/release/sov-rollup-nightstream" \
