//! Utility binary to generate deterministic keypairs and create a genesis bank.json file
...
fn main() -> Result<()> {
    ...
    let balance_per_account = "10000000000000";

    println!("Generating {} deterministic accounts...", num_accounts);

    let mut address_and_balances = Vec::with_capacity(num_accounts + 8);
