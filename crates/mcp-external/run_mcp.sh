...
export LIGERO_PROVER_BINARY_PATH="${LIGERO_PROVER_BINARY_PATH:-$WORKSPACE_ROOT/crates/adapters/ligero/bins/macos/bin/webgpu_prover}"
export LIGERO_SHADER_PATH="${LIGERO_SHADER_PATH:-$WORKSPACE_ROOT/crates/adapters/ligero/bins/macos/shader}"
