...
pub struct UnifiedBalanceResult {
    ...
    /// Total balance (transparent + privacy)
    ...
    S: Spec,
{
    ...
    let (address, transparent_amount) =
        get_default_token_balance(provider, wallet, token_id).await?;
    ...
    Ok(UnifiedBalanceResult {
        ...
        total_balance: total_balance_value.to_string(),
