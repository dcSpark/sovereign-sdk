...
use crate::{MidnightAddress, MidnightBlob, MidnightHash};
...
pub struct Model {
    ...
    /// Who submitted it. Converted to `Vec<u8>` [`MidnightAddress`]
    pub sender: Vec<u8>,
}
...
impl From<Model> for MidnightBlob {
    fn from(value: Model) -> Self {
        ...
        MidnightBlob::new(value.data, address, hash)
    }
}
