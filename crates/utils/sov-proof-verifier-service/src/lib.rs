...
// If this changes, update it by running the rollup-ligero build.
const ROLLUP_CHAIN_HASH: [u8; 32] = [
    146, 205, 123, 177, 140, 23, 198, 57, 245, 177, 194, 164, 218, 179, 221, 70, 184, 207, 116,
    77, 2, 68, 150, 44, 238, 75, 68, 84, 70, 41, 141, 104,
];
